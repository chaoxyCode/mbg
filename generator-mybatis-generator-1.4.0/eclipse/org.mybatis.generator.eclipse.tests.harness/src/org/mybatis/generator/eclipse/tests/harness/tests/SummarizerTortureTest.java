...
public class SummarizerTortureTest {
    ...
    public void testDifficultMethodsAndFields() throws IOException {
        InputStream resource =
                getClass()
                        .getResourceAsStream(
                                "/org/mybatis/generator/eclipse/tests/harness/tests/resources/StringifierExercizer.java.src");
        ...
        assertThat(
                summary,
                hasClass(CLASS_NAME, withField("decimalArray1", ofType("java.math.BigDecimal[]"))));
        assertThat(
                summary,
                hasClass(
                        CLASS_NAME,
                        withField("integerArray2", ofType("java.math.BigInteger[][]"))));
        ...
        assertThat(
                ...
                hasClass(
                        CLASS_NAME,
                        withMethod("<I extends List<String> & Closeable> intersectionType(I)")));
        ...
        assertThat(
                ...
                hasClass(
                        CLASS_NAME,
                        withMethod(
                                "someMethod(List<Map<Integer,java.lang.String>>,Map<Integer,List<String>>)")));
        ...
        assertThat(
                summary, hasClass(CLASS_NAME, withMethod("method22(List<? extends BigDecimal>)")));
        assertThat(
                summary,
                hasClass(
                        CLASS_NAME,
                        withMethod("method22(Map<Integer,? super java.math.BigDecimal>)")));
