...
/**
 * This class generates a hierarchy with multiple classes that have the same name in different
 * packages. It tests the ability of the generator to use fully qualified names in code generation
 * when the type is not explicitly imported.
 */
