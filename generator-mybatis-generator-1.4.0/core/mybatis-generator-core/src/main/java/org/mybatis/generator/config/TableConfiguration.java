...
public class TableConfiguration extends PropertyHolder {
    ...
    /**
     * Returns a List of Strings. The values are the columns that were specified to be ignored in
     * the table, but do not exist in the table.
     *
