...
public class InsertMultipleMethodGenerator extends AbstractMethodGenerator {
    ...
    public MethodAndImports generateMethodAndImports() {
        ...
        imports.add(
                new FullyQualifiedJavaType(
                        "org.mybatis.dynamic.sql.util.mybatis3.MyBatis3Utils")); //$NON-NLS-1$
        ...
        FullyQualifiedJavaType parameterType =
                new FullyQualifiedJavaType("java.util.Collection"); // $NON-NLS-1$
        ...
        method.addBodyLine(
                "return MyBatis3Utils.insertMultiple(this::insertMultiple, records, "
                        + //$NON-NLS-1$
                        tableFieldName
                        + //$NON-NLS-1$
                        ", c ->"); //$NON-NLS-1$
    ...
    public boolean callPlugins(Method method, Interface interfaze) {
        return context.getPlugins()
                .clientInsertMultipleMethodGenerated(method, interfaze, introspectedTable);
    }
