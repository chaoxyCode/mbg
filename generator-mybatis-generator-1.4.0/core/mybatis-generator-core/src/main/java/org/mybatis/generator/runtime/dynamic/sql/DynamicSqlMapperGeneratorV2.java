...
import org.mybatis.generator.runtime.dynamic.sql.elements.v2.*;
...
public class DynamicSqlMapperGeneratorV2 extends AbstractDynamicSqlMapperGenerator {
    ...
    protected void addInsertOneMethod(Interface interfaze) {
        InsertMethodGeneratorV2 generator =
                new InsertMethodGeneratorV2.Builder()
                        .withContext(context)
    ...
    protected void addSelectListField(Interface interfaze) {
        SelectListGenerator generator =
                new SelectListGenerator.Builder()
                        .withContext(context)
        ...
        if (fieldAndImports != null
                && generator.callPlugins(fieldAndImports.getField(), interfaze)) {
    ...
    protected void addBasicSelectOneMethod(Interface interfaze) {
        BasicSelectOneMethodGeneratorV2 generator =
                new BasicSelectOneMethodGeneratorV2.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withTableFieldName(tableFieldName)
    ...
    protected void addDeleteByPrimaryKeyMethod(Interface interfaze) {
        DeleteByPrimaryKeyMethodGeneratorV2 generator =
                new DeleteByPrimaryKeyMethodGeneratorV2.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withFragmentGenerator(fragmentGenerator)
                        .withTableFieldName(tableFieldName)
    ...
    protected void addInsertSelectiveMethod(Interface interfaze) {
        InsertSelectiveMethodGeneratorV2 generator =
                new InsertSelectiveMethodGeneratorV2.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withTableFieldName(tableFieldName)
                        .withRecordType(recordType)
    ...
    protected void addSelectByPrimaryKeyMethod(Interface interfaze) {
        SelectByPrimaryKeyMethodGeneratorV2 generator =
                new SelectByPrimaryKeyMethodGeneratorV2.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withTableFieldName(tableFieldName)
    ...
    protected void addUpdateByPrimaryKeyMethod(Interface interfaze) {
        UpdateByPrimaryKeyMethodGeneratorV2 generator =
                new UpdateByPrimaryKeyMethodGeneratorV2.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withTableFieldName(tableFieldName)
