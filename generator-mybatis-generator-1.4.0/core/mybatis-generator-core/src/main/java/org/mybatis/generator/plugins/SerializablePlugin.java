 ...
 *
 * <p>This plugin demonstrates adding capabilities to generated Java artifacts, and shows the proper
 * way to add imports to a compilation unit.
 *
 * <p>Important: This is a simplistic implementation of serializable and does not attempt to do any
...
public class SerializablePlugin extends PluginAdapter {
    ...
    public void setProperties(Properties properties) {
        ...
        suppressJavaInterface =
                Boolean.valueOf(properties.getProperty("suppressJavaInterface")); // $NON-NLS-1$
    }
