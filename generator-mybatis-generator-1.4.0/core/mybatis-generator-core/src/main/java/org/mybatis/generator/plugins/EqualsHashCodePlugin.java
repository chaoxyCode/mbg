 ...
 *
 * <p>The <code>equals</code> method generated by this class is correct in most cases, but will
 * probably NOT be correct if you have specified a rootClass - because our equals method only checks
 * the fields it knows about.
 *
 * <p>Similarly, the <code>hashCode</code> method generated by this class only relies on fields it
 * knows about. Anything you add, or fields in a super class will not be factored into the hash
 * code.
 *
 * @author Jeff Butler
 */
public class EqualsHashCodePlugin extends PluginAdapter {
    ...
    public void setProperties(Properties properties) {
        ...
        useEqualsHashCodeFromRoot =
                isTrue(properties.getProperty("useEqualsHashCodeFromRoot")); // $NON-NLS-1$
    }
    ...
    public boolean modelPrimaryKeyClassGenerated(
        ...
        generateHashCode(
                topLevelClass, introspectedTable.getPrimaryKeyColumns(), introspectedTable);
     ...
     *
     * <ul>
     *   <li>Other fields have been added to the generated classes
     *   <li>A <code>rootClass</code> is specified that holds state
     * </ul>
     *
    ...
    protected void generateEquals(
        ...
        method.addParameter(
                new Parameter(FullyQualifiedJavaType.getObjectInstance(), "that")); // $NON-NLS-1$
     ...
     *
     * <p>Note that this implementation is based on the eclipse foundation hashCode generator.
     *
     * @param topLevelClass the class to which the method will be added
     * @param introspectedColumns column definitions of this class and any superclass of this class
     * @param introspectedTable the table corresponding to this class
        ...
        while (iter.hasNext()) {
            ...
            if (fqjt.isPrimitive()) {
                if ("boolean".equals(fqjt.getFullyQualifiedName())) { // $NON-NLS-1$
                    ...
                    method.addBodyLine(sb.toString());
                    method.addBodyLine(
                            "result = prime * result + (int) (temp ^ (temp >>> 32));"); //$NON-NLS-1$
