...
public class KotlinFragmentGenerator {
    ...
    public KotlinFunctionParts getPrimaryKeyWhereClauseAndParameters() {
        ...
        for (IntrospectedColumn column : introspectedTable.getPrimaryKeyColumns()) {
            FullyQualifiedKotlinType kt =
                    JavaToKotlinTypeConverter.convert(column.getFullyQualifiedJavaType());
    ...
    private String getResultAnnotation(
            Set<String> imports, IntrospectedColumn introspectedColumn, boolean idColumn) {
        StringBuilder sb = new StringBuilder();
                ...
                .ifPresent(
                        introspectedColumn -> {
                            if (gk.isJdbcStandard()) {
                                ...
                                FullyQualifiedKotlinType kt =
                                        JavaToKotlinTypeConverter.convert(
    ...
    public static class Builder {
        ...
        public Builder withDynamicSqlSupportClassGenerator(
                KotlinDynamicSqlSupportClassGenerator generator) {
