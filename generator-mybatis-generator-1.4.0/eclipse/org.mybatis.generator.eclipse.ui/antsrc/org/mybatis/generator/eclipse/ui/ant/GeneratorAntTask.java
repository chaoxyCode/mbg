...
public class GeneratorAntTask extends Task {
    ...
    public void execute() throws BuildException {
        ...
        IProgressMonitor monitor =
                (IProgressMonitor)
                        getProject().getReferences().get(AntCorePlugin.ECLIPSE_PROGRESS_MONITOR);
        if (monitor == null) {
        ...
        try {
            ...
            EclipseProgressCallback progressCallback =
                    new EclipseProgressCallback(subMonitor.newChild(950));
    ...
    private void setLoggingImplementation() {
        try {
            ...
            log(
                    "WARNING: Logging Disabled.  Do you need to add a logging implementation to the launch classpath?",
                    Project.MSG_WARN);
        }
    }
