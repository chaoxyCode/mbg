...
public class HasAnnotationMember extends TypeSafeMatcher<AnnotationSummary> {

    private String annotationMember;

    public HasAnnotationMember(String annotationMember) {
    ...
    protected boolean matchesSafely(AnnotationSummary item) {
        return item.hasAnnotationMember(annotationMember);
    }
