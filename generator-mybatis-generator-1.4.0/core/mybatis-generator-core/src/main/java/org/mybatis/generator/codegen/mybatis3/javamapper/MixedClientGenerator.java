...
/**
 * This class overrides the base mapper to provide annotated methods for the methods that don't
 * require SQL provider support.
 *
 * @author Jeff Butler
 */
public class MixedClientGenerator extends JavaMapperGenerator {
    ...
    protected void addInsertMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateInsert()) {
            AbstractJavaMapperMethodGenerator methodGenerator =
                    new AnnotatedInsertMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
