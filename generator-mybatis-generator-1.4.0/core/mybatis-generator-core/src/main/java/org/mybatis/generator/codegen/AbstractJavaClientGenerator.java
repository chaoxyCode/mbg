...
/**
 * This class exists to that Java client generators can specify whether an XML generator is required
 * to match the methods in the Java client. For example, a Java client built entirely with
...
public abstract class AbstractJavaClientGenerator extends AbstractJavaGenerator {
     ...
     *
     * @return the matched XML generator. May return null if no XML is required by this generator
     */
