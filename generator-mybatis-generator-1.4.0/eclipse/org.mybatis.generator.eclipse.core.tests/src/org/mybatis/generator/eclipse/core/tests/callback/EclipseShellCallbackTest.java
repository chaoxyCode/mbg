...
import static org.mybatis.generator.eclipse.core.tests.callback.WorkspaceUtilities.*;
...
public class EclipseShellCallbackTest {
    ...
    public static void setup() throws CoreException {
        javaProject =
                createJavaProject(
                        "P", new String[] {"src/main/java", "generatedsrc"}, "bin", "1.5");
    }
    ...
    public void testCalculatingDirectoryOnDefaultSourceFolder() throws ShellException {
        ...
        IPath expectedPath =
                workspacePath
                        .append(javaProject.getElementName())
                        .append("src")
                        .append("main")
                        .append("java")
                        .append("org")
    ...
    public void testCalculatingDirectoryOnSpecificSourceFolder() throws ShellException {
        ...
        File directory =
                callback.getDirectory(
                        javaProject.getElementName() + "/generatedsrc", "org.mybatis.test");
        assertThat(directory, is(notNullValue()));
        assertThat(directory.exists(), is(true));
