...
/**
 * This class converts Java types to Kotlin types. It is not meant to cover all cases. The main
 * purpose is to convert type calculated by the database introspector into appropriate types for
 * Kotlin - which means that it covers Java primitives, Strings, and primitive wrapper classes as
 * those Java types have replacements in Kotlin.
 *
 * @author Jeff Butler
 */
public class JavaToKotlinTypeConverter {
    ...
    static {
        ...
        typeMap.put(
                "java.lang.String[]", "kotlin.Array<kotlin.String>"); // $NON-NLS-1$ //$NON-NLS-2$
        ...
        typeMap.put(
                "java.lang.Character[]", "kotlin.Array<kotlin.Char>"); // $NON-NLS-1$ //$NON-NLS-2$
        ...
        typeMap.put(
                "java.lang.Double[]", "kotlin.Array<kotlin.Double>"); // $NON-NLS-1$ //$NON-NLS-2$
        typeMap.put(
                "java.lang.Boolean[]", "kotlin.Array<kotlin.Boolean>"); // $NON-NLS-1$ //$NON-NLS-2$
    }
