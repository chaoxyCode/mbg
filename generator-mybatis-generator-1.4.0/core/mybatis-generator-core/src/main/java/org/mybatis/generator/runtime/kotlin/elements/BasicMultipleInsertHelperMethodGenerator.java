...
public class BasicMultipleInsertHelperMethodGenerator extends AbstractKotlinFunctionGenerator {
        ...
        KotlinFunctionAndImports functionAndImports =
                KotlinFunctionAndImports.withFunction(
                                KotlinFunction.newOneLineFunction(
                                                mapperName + ".insertMultipleHelper") // $NON-NLS-1$
                                        .withArgument(
                                                KotlinArg.newArg(
                                                        ...
                                                        .build())
                                        .withCodeLine(
                                                "insertMultiple(multipleInsertStatement.insertStatement," //$NON-NLS-1$
    ...
    public static class Builder
            extends BaseBuilder<Builder, BasicMultipleInsertHelperMethodGenerator> {
