...
public interface CommentGenerator {
     ...
     *
     * <p>Because of difficulties with the Java file merger, the default implementation of this
     * method should NOT add comments. Comments should only be added if specifically requested by
     * the user (for example, by enabling table remark comments).
     *
     ...
     * be used to add a general file comment (such as a copyright notice). However, note that the
     * Java file merge function in Eclipse does not deal with this comment. If you run the generator
    ...
    default void addGeneralFunctionComment(
            KotlinFunction kf, IntrospectedTable introspectedTable, Set<String> imports) {}

    default void addGeneralPropertyComment(
