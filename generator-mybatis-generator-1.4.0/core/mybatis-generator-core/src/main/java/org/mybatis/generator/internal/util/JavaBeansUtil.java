...
public class JavaBeansUtil {
     ...
     */
    public static String getGetterMethodName(
            String property, FullyQualifiedJavaType fullyQualifiedJavaType) {
     ...
     *
     * <ol>
     *   <li>If the first character is lower case, then OK
     *   <li>If the first two characters are upper case, then OK
     *   <li>If the first character is upper case, and the second character is lower case, then the
     *       first character should be made lower case
     * </ol>
     *
     * <p>For example:
     *
    ...
    public static String getValidPropertyName(String inputString) {
        ...
        if (inputString == null) {
            ...
            if (Character.isUpperCase(inputString.charAt(0))
                ...
                answer =
                        inputString.substring(0, 1).toLowerCase(Locale.US)
    ...
    public static Method getJavaBeansGetter(
    ...
    public static Method getJavaBeansGetterWithGeneratedAnnotation(
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable,
        ...
        addGeneratedGetterAnnotation(
                method, introspectedColumn, context, introspectedTable, compilationUnit);
        return method;
    }
    ...
    private static void addGeneratedGetterJavaDoc(
            Method method,
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable) {
    ...
    private static void addGeneratedGetterAnnotation(
            Method method,
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable,
    ...
    public static Field getJavaBeansField(
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable) {
    ...
    public static Field getJavaBeansFieldWithGeneratedAnnotation(
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable,
            CompilationUnit compilationUnit) {
        ...
        addGeneratedAnnotation(
                field, context, introspectedColumn, introspectedTable, compilationUnit);
        return field;
    }
    ...
    private static void addGeneratedJavaDoc(
            Field field,
            Context context,
            IntrospectedColumn introspectedColumn,
            IntrospectedTable introspectedTable) {
    ...
    private static void addGeneratedAnnotation(
            Field field,
            Context context,
            IntrospectedColumn introspectedColumn,
            IntrospectedTable introspectedTable,
    ...
    public static Method getJavaBeansSetter(
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable) {
    ...
    public static Method getJavaBeansSetterWithGeneratedAnnotation(
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable,
            CompilationUnit compilationUnit) {
    ...
    private static void addGeneratedSetterJavaDoc(
            Method method,
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable) {
    ...
    private static void addGeneratedSetterAnnotation(
            Method method,
            IntrospectedColumn introspectedColumn,
            Context context,
            IntrospectedTable introspectedTable,
    ...
    private static boolean isTrimStringsEnabled(IntrospectedColumn column) {
        String trimSpaces =
                column.getProperties().getProperty(PropertyRegistry.MODEL_GENERATOR_TRIM_STRINGS);
        if (trimSpaces != null) {
            return isTrue(trimSpaces);
        }
