...
public class DefaultCommentGenerator implements CommentGenerator {
     ...
     * the Javadoc tag - however, if you do not include the Javadoc tag then the Java merge
    ...
    public void addModelClassComment(
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            ...
            String[] remarkLines =
                    remarks.split(System.getProperty("line.separator")); // $NON-NLS-1$
    ...
    public void addFileComment(KotlinFile kotlinFile) {
        ...
        kotlinFile.addFileCommentLine(
                " * Auto-generated file. Created by MyBatis Generator"); //$NON-NLS-1$
        if (!suppressDate) {
            kotlinFile.addFileCommentLine(
