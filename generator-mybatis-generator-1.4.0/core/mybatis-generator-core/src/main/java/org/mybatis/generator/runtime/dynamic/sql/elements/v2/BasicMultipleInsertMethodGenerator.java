...
public class BasicMultipleInsertMethodGenerator extends AbstractMethodGenerator {
    ...
    private MethodAndImports generateMethodWithoutGeneratedKeys() {
        ...
        FullyQualifiedJavaType annotation =
                new FullyQualifiedJavaType(
                        "org.apache.ibatis.annotations.InsertProvider"); //$NON-NLS-1$
        ...
        method.addAnnotation(
                "@InsertProvider(type=SqlProviderAdapter.class, method=\"insertMultiple\")"); //$NON-NLS-1$
    ...
    private MethodAndImports generateMethodWithGeneratedKeys(GeneratedKey gk) {
        ...
        imports.add(
                new FullyQualifiedJavaType("org.apache.ibatis.annotations.Param")); // $NON-NLS-1$
                ...
                .ifPresent(
                        introspectedColumn -> {
                            if (gk.isJdbcStandard()) {
                                ...
                                sb.append(
                                        "@Options(useGeneratedKeys=true,keyProperty=\"records."); //$NON-NLS-1$
    ...
    public boolean callPlugins(Method method, Interface interfaze) {
        return context.getPlugins()
                .clientBasicInsertMultipleMethodGenerated(method, interfaze, introspectedTable);
    }
