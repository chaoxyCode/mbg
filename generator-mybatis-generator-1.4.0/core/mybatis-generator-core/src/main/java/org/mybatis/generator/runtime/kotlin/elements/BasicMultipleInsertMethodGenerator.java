        ...
        KotlinFunctionAndImports functionAndImports =
                KotlinFunctionAndImports.withFunction(
                                KotlinFunction.newOneLineFunction("insertMultiple") // $NON-NLS-1$
                                        ...
                                        .withArgument(
                                                KotlinArg.newArg(
                                                                "multipleInsertStatement") //$NON-NLS-1$
                                                        .withDataType(
                                                                "MultiRowInsertStatementProvider<" //$NON-NLS-1$
                                                                        + recordType
                                                                                .getShortNameWithTypeArguments()
                                                                        + ">") //$NON-NLS-1$
                                                        .build())
                                        .withAnnotation(
                                                "@InsertProvider(type=SqlProviderAdapter::class," //$NON-NLS-1$
