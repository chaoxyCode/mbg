...
/**
 * This class assumes that classes are cached elsewhere for performance reasons, but also to make
 * sure that any native libraries are only loaded one time. This avoids the dreaded
...
public class JDBCConnectionFactory implements ConnectionFactory {
    ...
    /**
     * This constructor is called when there is a JDBCConnectionConfiguration specified in the
     * configuration.
     *
    ...
    /**
     * This constructor is called when this connection factory is specified as the type in a
