...
public class MatcherTest {
    ...
    public static void beforeClass() throws IOException {
        InputStream resource =
                MatcherTest.class.getResourceAsStream(
    ...
    public void testHasClassWithInterfaceWithMethodSucceeds() {
        assertThat(
                cuSummary,
                hasClass(OUTER_CLASS, withInterface(INNER_INTERFACE, withMethod("execute()"))));
    }
    ...
    public void testHasClassWithEnumWithEnumConstantSucceeds() {
        assertThat(
                cuSummary, hasClass(OUTER_CLASS, withEnum(INNER_ENUM, withEnumConstant("GEORGE"))));
    }

    @Test(expected = AssertionError.class)
    public void testHasClassWithEnumWithEnumConstantFails() {
        assertThat(
                cuSummary, hasClass(OUTER_CLASS, withEnum(INNER_ENUM, withEnumConstant("FRED"))));
    }

    @Test
    public void testHasClassWithEnumWithEnumConstantCountSucceeds() {
        assertThat(
                cuSummary, hasClass(OUTER_CLASS, withEnum(INNER_ENUM, withEnumConstantCount(2))));
    }

    @Test(expected = AssertionError.class)
    public void testHasClassWithEnumWithEnumConstantCountFails() {
        assertThat(
                cuSummary, hasClass(OUTER_CLASS, withEnum(INNER_ENUM, withEnumConstantCount(3))));
    }
    ...
    public void testHasClassWithAnnotationWithAnnotationMemberSucceeds() {
        assertThat(
                ...
                hasClass(
                        OUTER_CLASS,
                        withAnnotation(INNER_ANNOTATION, withAnnotationMember("amount"))));
    }
    ...
    public void testHasClassWithAnnotationWithAnnotationMemberFails() {
        assertThat(
                ...
                hasClass(
                        OUTER_CLASS,
                        withAnnotation(INNER_ANNOTATION, withAnnotationMember("fakeMember"))));
    }
    ...
    public void testHasClassWithAnnotationWithAnnotationMemberCountSucceeds() {
        assertThat(
                ...
                hasClass(
                        OUTER_CLASS,
                        withAnnotation(INNER_ANNOTATION, withAnnotationMemberCount(1))));
    }
    ...
    public void testHasClassWithAnnotationWithAnnotationMemberCountFails() {
        assertThat(
                ...
                hasClass(
                        OUTER_CLASS,
                        withAnnotation(INNER_ANNOTATION, withAnnotationMemberCount(2))));
    }
    ...
    public void testHasClassWithAnnotationWithFakeAnnotationMemberCountFails() {
        assertThat(
                ...
                hasClass(
                        OUTER_CLASS,
                        withAnnotation(FAKE_ANNOTATION, withAnnotationMemberCount(2))));
    }
