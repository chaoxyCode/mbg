 ...
 * <p>Example:
 *
 * <p>Given the domain class <code>MyDomainClass</code> with setter-method <code>setValue(Object v)
 * </code>
 *
 * <p>The plugin will create the additional Method <code>public MyDomainClass withValue(Object v)
 * </code>
 *
 * @author Stefan Lack
 */
        ...
        if (introspectedTable.getTargetRuntime() == TargetRuntime.MYBATIS3_DSQL) {
            context.getCommentGenerator()
                    .addGeneralMethodAnnotation(
                            fluentMethod, introspectedTable, topLevelClass.getImportedTypes());
        } else {
