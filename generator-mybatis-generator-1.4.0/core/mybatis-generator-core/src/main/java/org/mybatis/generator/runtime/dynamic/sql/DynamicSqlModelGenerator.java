...
/**
 * This model generator builds a flat model with default constructor and getters/setters. It does
 * not support the immutable model, or constructor based attributes.
 *
 * @author Jeff Butler
 */
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            Field field =
                    getJavaBeansFieldWithGeneratedAnnotation(
                            introspectedColumn, context, introspectedTable, topLevelClass);
    ...
    private void addParameterizedConstructor(TopLevelClass topLevelClass) {
        ...
        context.getCommentGenerator()
                .addGeneralMethodAnnotation(
                        method, introspectedTable, topLevelClass.getImportedTypes());
