...
public interface JavaTypeResolver {
     ...
     * warning is that code generation can continue, but that the results may not be what is
     * expected.
     *
     ...
     * @return the calculated type, or null if an unsupported data type. If null is returned, we
     *     will set the type to Object and issue a warning unless the column is ignored or otherwise
     *     overridden
     */
     ...
     *
     * @param introspectedColumn the column whose Java type needs to be calculated
     * @return the calculated type name, or null if an unsupported data type. If null is returned,
     *     we will set the type to OTHER and issue a warning unless the column is ignored or
