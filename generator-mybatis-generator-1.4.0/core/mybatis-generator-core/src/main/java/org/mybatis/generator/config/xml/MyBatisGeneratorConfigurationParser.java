...
public class MyBatisGeneratorConfigurationParser {
            ...
            if (stringHasValue(resource)) {
                ...
                if (resourceUrl == null) {
                    throw new XMLParserException(
                            getString("RuntimeError.15", resource)); // $NON-NLS-1$
                }
            } else {
    ...
    protected void parseTable(Context context, Node node) {
        ...
        String enableSelectByPrimaryKey =
                attributes.getProperty("enableSelectByPrimaryKey"); // $NON-NLS-1$
        ...
        String enableSelectByExample =
                attributes.getProperty("enableSelectByExample"); // $NON-NLS-1$
        ...
        String enableUpdateByPrimaryKey =
                attributes.getProperty("enableUpdateByPrimaryKey"); // $NON-NLS-1$
        ...
        String enableDeleteByPrimaryKey =
                attributes.getProperty("enableDeleteByPrimaryKey"); // $NON-NLS-1$
        ...
        String enableDeleteByExample =
                attributes.getProperty("enableDeleteByExample"); // $NON-NLS-1$
        ...
        String enableUpdateByExample =
                attributes.getProperty("enableUpdateByExample"); // $NON-NLS-1$
        ...
        String selectByPrimaryKeyQueryId =
                attributes.getProperty("selectByPrimaryKeyQueryId"); // $NON-NLS-1$
        if (stringHasValue(selectByPrimaryKeyQueryId)) {
            tc.setSelectByPrimaryKeyQueryId(selectByPrimaryKeyQueryId);
        }

        String selectByExampleQueryId =
                attributes.getProperty("selectByExampleQueryId"); // $NON-NLS-1$
    ...
    String parsePropertyTokens(String s) {
        ...
        while (markerStartIndex > -1) {
            ...
            while (nestedStartIndex > -1
                    && markerEndIndex > -1
                    && nestedStartIndex < markerEndIndex) {
    ...
    protected void parseCommentGenerator(Context context, Node node) {
        CommentGeneratorConfiguration commentGeneratorConfiguration =
                new CommentGeneratorConfiguration();
    ...
    /**
     * This method resolve a property from one of the three sources: system properties, properties
     * loaded from the &lt;properties&gt; configuration element, and "extra" properties that may be
     * supplied by the Maven or Ant environments.
     *
     * <p>If there is a name collision, system properties take precedence, followed by configuration
     * properties, followed by extra properties.
     *
     * @param key property key
     * @return the resolved property. This method will return null if the property is undefined in
     *     any of the sources.
     */
