...
/**
 * This is a base class for Classes, Enums, and Interfaces. They all have methods and super
 * interfaces, as well as a name, fields and inner Annotations, Classes, Enums, and Interfaces.
 *
 * @author Jeff Butler
 */
public abstract class AbstractTypeOrEnumSummary extends AbstractBodyElementSummary {
    ...
    protected abstract static class AbstractTypeOrEnumSummaryBuilder<
                    T extends AbstractTypeOrEnumSummaryBuilder<T>>
            extends AbstractBodyElementSummaryBuilder<T> {
