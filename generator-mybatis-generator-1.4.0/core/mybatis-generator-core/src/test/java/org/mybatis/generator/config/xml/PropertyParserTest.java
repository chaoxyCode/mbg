...
public class PropertyParserTest {
    ...
    public void testNoMatches() {
        ...
        String result =
                parser.parsePropertyTokens(
                        "${gen.code.package}.${gen.code.mapper}.${gen.code.subpackage}");

        assertThat(result)
                .isEqualTo("${gen.code.package}.${gen.code.mapper}.${gen.code.subpackage}");
    }
    ...
    public void testSingleValue() {
        ...
        MyBatisGeneratorConfigurationParser parser =
                new MyBatisGeneratorConfigurationParser(properties);
    ...
    public void testTwoValues() {
        ...
        assertThat(parser.parsePropertyTokens("${gen.code.package}.${gen.code.mapper}"))
    ...
    public void testNestedValues() {
        ...
        String result =
                parser.parsePropertyTokens("${jdbc.${project.${domain}}.${env.${addr}}.url}");
