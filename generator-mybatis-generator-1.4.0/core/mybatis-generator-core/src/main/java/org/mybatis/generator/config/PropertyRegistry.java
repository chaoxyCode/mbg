 ...
 * This helps document and maintain the different properties, and helps to avoid spelling errors.
 *
 * @author Jeff Butler
 */
public class PropertyRegistry {
    ...
    public static final String TABLE_USE_COMPOUND_PROPERTY_NAMES =
            "useCompoundPropertyNames"; //$NON-NLS-1$
    ...
    public static final String TABLE_SELECT_ALL_ORDER_BY_CLAUSE =
            "selectAllOrderByClause"; //$NON-NLS-1$
    ...
    public static final String MODEL_GENERATOR_EXAMPLE_PACKAGE =
            "exampleTargetPackage"; //$NON-NLS-1$
    public static final String MODEL_GENERATOR_EXAMPLE_PROJECT =
            "exampleTargetProject"; //$NON-NLS-1$
    ...
    public static final String COMMENT_GENERATOR_SUPPRESS_ALL_COMMENTS =
            "suppressAllComments"; //$NON-NLS-1$
    public static final String COMMENT_GENERATOR_ADD_REMARK_COMMENTS =
            "addRemarkComments"; //$NON-NLS-1$
