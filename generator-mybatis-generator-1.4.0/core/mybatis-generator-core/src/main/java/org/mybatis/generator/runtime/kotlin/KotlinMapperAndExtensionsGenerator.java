...
import org.mybatis.generator.runtime.kotlin.elements.*;
...
public class KotlinMapperAndExtensionsGenerator extends AbstractKotlinGenerator {
    ...
    protected void preCalculate() {
        supportClassGenerator =
                new KotlinDynamicSqlSupportClassGenerator(context, introspectedTable);
        ...
        fragmentGenerator =
                new KotlinFragmentGenerator.Builder()
    ...
    protected KotlinFile createMapperExtensionsFile() {
        ...
        KotlinFile kf =
                new KotlinFile(
                        type.getShortNameWithoutTypeArguments() + "Extensions"); // $NON-NLS-1$
        kf.setPackage(type.getPackageName());
    ...
    protected KotlinType createMapperInterface(KotlinFile kotlinFile) {
        ...
        KotlinType intf =
                KotlinType.newInterface(type.getShortNameWithoutTypeArguments())
    ...
    protected void addBasicCountMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicCountMethodGenerator generator =
                new BasicCountMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .build();
    ...
    protected void addBasicDeleteMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicDeleteMethodGenerator generator =
                new BasicDeleteMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .build();
    ...
    protected void addBasicInsertMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicInsertMethodGenerator generator =
                new BasicInsertMethodGenerator.Builder()
                        .withContext(context)
    ...
    protected void addBasicSelectManyMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicSelectManyMethodGenerator generator =
                new BasicSelectManyMethodGenerator.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
    ...
    protected void addBasicUpdateMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicUpdateMethodGenerator generator =
                new BasicUpdateMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .build();
    ...
    public List<KotlinFile> getKotlinFiles() {
        ...
        if (context.getPlugins()
                .dynamicSqlSupportGenerated(
                        supportFile, supportClassGenerator.getInnerObject(), introspectedTable)) {
    ...
    protected void addInsertOneMethod(KotlinFile kotlinFile, String mapperName) {
        InsertMethodGenerator generator =
                new InsertMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addBasicInsertMultipleMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicMultipleInsertMethodGenerator generator =
                new BasicMultipleInsertMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addBasicInsertMultipleHelperMethod(KotlinFile kotlinFile, String mapperName) {
        BasicMultipleInsertHelperMethodGenerator generator =
                new BasicMultipleInsertHelperMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addInsertMultipleMethod(KotlinFile kotlinFile, String mapperName) {
        InsertMultipleMethodGenerator generator =
                new InsertMultipleMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addInsertMultipleVarargMethod(KotlinFile kotlinFile, String mapperName) {
        InsertMultipleVarargMethodGenerator generator =
                new InsertMultipleVarargMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addCountByExampleMethod(KotlinFile kotlinFile, String mapperName) {
        GeneralCountMethodGenerator generator =
                new GeneralCountMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addDeleteByExampleMethod(KotlinFile kotlinFile, String mapperName) {
        GeneralDeleteMethodGenerator generator =
                new GeneralDeleteMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addColumnListProperty(KotlinFile kotlinFile) {
        ColumnListGenerator generator =
                new ColumnListGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withTableFieldImport(supportClassGenerator.getInnerObjectImport())
                        .build();
        ...
        if (propertyAndImports != null
                && generator.callPlugins(propertyAndImports.getProperty(), kotlinFile)) {
    ...
    protected void addSelectByExampleMethod(KotlinFile kotlinFile, String mapperName) {
        ...
        GeneralSelectMethodGenerator generator =
                new GeneralSelectMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addSelectDistinctByExampleMethod(KotlinFile kotlinFile, String mapperName) {
        GeneralSelectDistinctMethodGenerator generator =
                new GeneralSelectDistinctMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addGeneralSelectOneMethod(KotlinFile kotlinFile, String mapperName) {
        GeneralSelectOneMethodGenerator generator =
                new GeneralSelectOneMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addUpdateByExampleMethod(KotlinFile kotlinFile, String mapperName) {
        GeneralUpdateMethodGenerator generator =
                new GeneralUpdateMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withMapperName(mapperName)
    ...
    protected void addUpdateAllMethod(KotlinFile kotlinFile) {
        UpdateAllColumnsMethodGenerator generator =
                new UpdateAllColumnsMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withFragmentGenerator(fragmentGenerator)
    ...
    protected void addBasicSelectOneMethod(KotlinFile kotlinFile, KotlinType kotlinType) {
        BasicSelectOneMethodGenerator generator =
                new BasicSelectOneMethodGenerator.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
    ...
    protected void addDeleteByPrimaryKeyMethod(KotlinFile kotlinFile, String mapperName) {
        DeleteByPrimaryKeyMethodGenerator generator =
                new DeleteByPrimaryKeyMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withFragmentGenerator(fragmentGenerator)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
    ...
    protected void addInsertSelectiveMethod(KotlinFile kotlinFile, String mapperName) {
        InsertSelectiveMethodGenerator generator =
                new InsertSelectiveMethodGenerator.Builder()
                        .withContext(context)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
                        .withRecordType(recordType)
    ...
    protected void addSelectByPrimaryKeyMethod(KotlinFile kotlinFile, String mapperName) {
        SelectByPrimaryKeyMethodGenerator generator =
                new SelectByPrimaryKeyMethodGenerator.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
    ...
    protected void addUpdateByPrimaryKeyMethod(KotlinFile kotlinFile, String mapperName) {
        UpdateByPrimaryKeyMethodGenerator generator =
                new UpdateByPrimaryKeyMethodGenerator.Builder()
                        .withContext(context)
                        .withFragmentGenerator(fragmentGenerator)
                        .withIntrospectedTable(introspectedTable)
                        .withDynamicSqlSupportClassGenerator(supportClassGenerator)
