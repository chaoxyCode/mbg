...
public class SqlScriptComposite extends AbstractGeneratorComposite {
    ...
    private void createConnectionGroup(Composite parent) {
        ...
        txtJdbcDriver.addModifyListener(
                new ModifyListener() {
                    @Override
        ...
        btnSecureStorage.addSelectionListener(
    ...
    public void initializeFrom(ILaunchConfiguration configuration) {
        ...
        btnSecureStorage.setSelection(
                getBooleanOrFalse(configuration, ATTR_SQL_SCRIPT_SECURE_CREDENTIALS));
    ...
    public void performApply(ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(
                ATTR_SQL_SCRIPT_SECURE_CREDENTIALS, btnSecureStorage.getSelection());
