...
/** @author Jeff Butler */
public class UpdateByExampleTest extends AbstractMixedHierarchicalImmutableTest {
    ...
    public void testPKBlobsUpdateByExampleSelective() {
        ...
        try {
            ...
            PkblobsWithBLOBs newRecord =
                    new PkblobsWithBLOBs(null, generateRandomBlob(), null, null);
    ...
    public void testPKFieldsBlobsUpdateByExampleSelective() {
        ...
        try {
            ...
            PkfieldsblobsWithBLOBs newRecord =
                    new PkfieldsblobsWithBLOBs(null, null, "Fred", null, null);
    ...
    public void testFieldsBlobsUpdateByExampleSelective() {
        ...
        try {
            ...
            FieldsblobsWithBLOBs newRecord =
                    new FieldsblobsWithBLOBs(null, "Doe", null, null, null);
    ...
    public void testFieldsBlobsUpdateByExampleWithBLOBs() {
        ...
        try {
            ...
            FieldsblobsWithBLOBs newRecord =
                    new FieldsblobsWithBLOBs("Scott", "Doe", null, null, null);
            FieldsblobsExample example = new FieldsblobsExample();
            example.createCriteria().andFirstnameLike("S%");
            int rows = mapper.updateByExampleWithBLOBs(newRecord, example);
            assertEquals(1, rows);
