...
/**
 * This plugin generates a MapperConfig file containing mapper entries for SQL maps generated for
 * MyBatis3. This demonstrates hooking into the code generation lifecycle and generating additional
 * XML files.
 *
 * <p>This plugin accepts three properties:
 *
 * <ul>
 *   <li><code>fileName</code> (optional) the name of the generated file. this defaults to
 *       "SqlMapConfig.xml" if not specified.
 *   <li><code>targetPackage</code> (required) the name of the package where the file should be
 *       placed. Specified like "com.mycompany.sql".
 *   <li><code>targetProject</code> (required) the name of the project where the file should be
 *       placed.
 * </ul>
 *
 * <p>Note: targetPackage and targetProject follow the same rules as the targetPackage and
 * targetProject values on the sqlMapGenerator configuration element.
 *
 * @author Jeff Butler
 */
public class MapperConfigPlugin extends PluginAdapter {
    ...
    public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
        ...
        root.addElement(
                new TextElement("    to this file before it is usable by MyBatis.")); // $NON-NLS-1$
        ...
        GeneratedXmlFile gxf =
                new GeneratedXmlFile(
                        ...
                        properties.getProperty(
                                "fileName", "MapperConfig.xml"), // $NON-NLS-1$ //$NON-NLS-2$
