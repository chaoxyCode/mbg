...
public class Utilities {
    ...
    public static CompilationUnitSummary getCompilationUnitSummaryFromSource(String javaSource)
            throws IOException {
    ...
    public static <T> T newInstance(Class<? extends T> type) {
        try {
            ...
            throw new CantCreateInstanceException(
                    "error creating instance of class " + type.getName(), e);
        }
    }
