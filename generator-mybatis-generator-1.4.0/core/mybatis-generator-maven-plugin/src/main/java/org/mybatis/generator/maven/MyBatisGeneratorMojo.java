...
public class MyBatisGeneratorMojo extends AbstractMojo {
    ...
    /**
     * Location of a SQL script file to run before generating code. If null, then no script will be
     * run. If not null, then jdbcDriver, jdbcURL must be supplied also, and jdbcUserId and
     * jdbcPassword may be supplied.
     */
    ...
    /**
     * If true, then dependencies in scope compile, provided, and system scopes will be added to the
     * classpath of the generator. These dependencies will be searched for JDBC drivers, root
     * classes, root interfaces, generator plugins, etc.
     */
    ...
    /**
     * If true, then dependencies in all scopes will be added to the classpath of the generator.
     * These dependencies will be searched for JDBC drivers, root classes, root interfaces,
     * generator plugins, etc.
     */
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            myBatisGenerator.generate(
                    new MavenProgressCallback(getLog(), verbose),
                    contextsToRun,
    ...
    private void runScriptIfNecessary() throws MojoExecutionException {
        ...
        SqlScriptRunner scriptRunner =
                new SqlScriptRunner(sqlScript, jdbcDriver, jdbcURL, jdbcUserId, jdbcPassword);
