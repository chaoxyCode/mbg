 ...
 *
 * <ul>
 *   <li><code>searchString</code> (required) the regular expression of the name search.
 *   <li><code>replaceString</code> (required) the replacement String.
 * </ul>
 *
 * <p>For example, to change the name of the generated Example classes from xxxExample to
 * xxxCriteria, specify the following:
 *
 * <dl>
 *   <dt>searchString
 *   <dd>Example$
