...
import mbg.test.mb3.generated.simpleannotated.mapper.*;
import mbg.test.mb3.generated.simpleannotated.model.*;
...
public class SimpleAnnotatedTest extends AbstractSimpleAnnotatedTest {
    ...
    public void testPkfieldsblobs() {
        ...
        try {
            ...
            Pkfieldsblobs returnedRecord =
                    mapper.selectByPrimaryKey(record.getId1(), record.getId2());
            assertNotNull(returnedRecord);
            assertTrue(TestUtilities.blobsAreEqual(record.getBlob1(), returnedRecord.getBlob1()));
