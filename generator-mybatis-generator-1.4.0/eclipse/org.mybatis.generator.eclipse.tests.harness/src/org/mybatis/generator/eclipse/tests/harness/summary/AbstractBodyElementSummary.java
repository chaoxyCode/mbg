...
/**
 * This is a base class for Annotations, Classes, Enums, and Interfaces. They all have a name and
 * fields. They can also contain inner Annotations, Classes, Enums, and Interfaces.
 *
 * @author Jeff Butler
 */
public abstract class AbstractBodyElementSummary extends AbstractSummary {
    ...
    protected abstract static class AbstractBodyElementSummaryBuilder<
                    T extends AbstractBodyElementSummaryBuilder<T>>
            extends AbstractSummaryBuilder<T> {
