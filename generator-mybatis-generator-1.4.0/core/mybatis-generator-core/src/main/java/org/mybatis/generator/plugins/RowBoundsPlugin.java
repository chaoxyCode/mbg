...
/**
 * This plugin will add selectByExample methods that include rowBounds parameters to the generated
 * mapper interface. This plugin is only valid for MyBatis3.
 *
 * @author Jeff Butler
 */
public class RowBoundsPlugin extends PluginAdapter {
    ...
    public boolean validate(List<String> warnings) {
        if ("MyBatis3DynamicSqlV2".equalsIgnoreCase(context.getTargetRuntime()) // $NON-NLS-1$
                || "MyBatis3DynamicSql"
                        .equalsIgnoreCase(context.getTargetRuntime())) { // $NON-NLS-1$
    ...
    private void addNewComposedFunction(
            Interface interfaze,
        ...
        interfaze.addImportedType(
                new FullyQualifiedJavaType("java.util.function.Function")); // $NON-NLS-1$

        FullyQualifiedJavaType returnType =
                new FullyQualifiedJavaType(
                        "Function<SelectStatementProvider, " //$NON-NLS-1$
    ...
    private void copyAndSaveElement(XmlElement element, FullyQualifiedTable fqt) {
        ...
        for (Iterator<Attribute> iterator = newElement.getAttributes().iterator();
                iterator.hasNext(); ) {
            ...
            if ("id".equals(attribute.getName())) { // $NON-NLS-1$
                ...
                Attribute newAttribute =
                        new Attribute(
                                "id",
                                attribute.getValue()
                                        + "WithRowbounds"); //$NON-NLS-1$ //$NON-NLS-2$
